...
<body>
    ...
    <div class="limiter">
        <div class="container-login100" style="background: url('{{ url('depan/gambar/uinstsjambi.jpeg') }}');background-size:cover">
            <div class="wrap-login100">
                <form class="login100-form" method="POST" action="{{ route('adm.post.login') }}" autocomplete="off">
                    @csrf
